...
public class SignExpresswayDistanceFromLocation6UpdatePacket {
    ...
    public SignExpresswayDistanceFromLocation6UpdatePacket(FriendlyByteBuf buf) {
        ...
        this.expressway1 = buf.readEnum(SignExpresswayDistanceFromLocation6Entity.Expressway.class);
        this.expressway2 = buf.readEnum(SignExpresswayDistanceFromLocation6Entity.Expressway.class);
