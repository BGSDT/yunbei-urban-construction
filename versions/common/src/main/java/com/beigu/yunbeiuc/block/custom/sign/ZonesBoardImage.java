...
public class ZonesBoardImage extends BaseEntityBlock {
    ...
    public void appendHoverText(ItemStack stack, @Nullable BlockGetter world, List<Component> tooltip, TooltipFlag options) {
        tooltip.add(new net.minecraft.network.chat.TranslatableComponent("block.yunbeiuc.zones_board.tooltip"));
    ...
    private Type determineType(BlockState behindState) {
        ...
        for (net.minecraft.world.level.block.state.properties.Property<?> property : behindState.getProperties()) {
