...
public class RoadClosedBarricadeGuardrail3 extends DirectionalBlock {
    public static final EnumProperty<BedPart> PART = BlockStateProperties.BED_PART;

    private static final VoxelShape FOOT_SHAPE_NORTH = Block.box(5, 0, 0, 16, 18, 16);
    private static final VoxelShape FOOT_SHAPE_SOUTH = Block.box(5, 0, 0, 16, 18, 11);
    private static final VoxelShape FOOT_SHAPE_EAST = Block.box(0, 0, 5, 16, 18, 16);
    private static final VoxelShape FOOT_SHAPE_WEST = Block.box(5, 0, 0, 11, 18, 16);

    private static final VoxelShape HEAD_SHAPE_NORTH = Block.box(0, 0, 0, 11, 18, 16);
    private static final VoxelShape HEAD_SHAPE_SOUTH = Block.box(5, 0, 0, 16, 18, 11);
    private static final VoxelShape HEAD_SHAPE_EAST = Block.box(0, 0, 5, 11, 18, 16);
    private static final VoxelShape HEAD_SHAPE_WEST = Block.box(5, 0, 0, 16, 18, 11);
    public RoadClosedBarricadeGuardrail3(BlockBehaviour.Properties properties) {
        super(properties);
