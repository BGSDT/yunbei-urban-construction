...
public class SignGuideIntersectionAdvanceWarning5 extends EntityBlockCompat {
    ...
    public SignGuideIntersectionAdvanceWarning5(BlockBehaviour.Properties properties) {
        super(properties);
