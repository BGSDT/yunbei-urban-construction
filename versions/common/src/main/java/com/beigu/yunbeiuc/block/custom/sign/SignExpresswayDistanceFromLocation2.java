...
public class SignExpresswayDistanceFromLocation2 extends EntityBlockCompat {
    ...
    public SignExpresswayDistanceFromLocation2(BlockBehaviour.Properties properties) {
        super(properties);
