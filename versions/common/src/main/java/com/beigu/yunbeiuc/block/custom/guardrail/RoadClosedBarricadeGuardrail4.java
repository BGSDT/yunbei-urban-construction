...
public class RoadClosedBarricadeGuardrail4 extends DirectionalBlock {
    ...
    private static final VoxelShape FOOT_SHAPE_SOUTH = Block.box(2, 0, 0, 16, 18, 16);
    private static final VoxelShape FOOT_SHAPE_EAST = Block.box(0, 0, 5, 16, 18, 16);
    private static final VoxelShape FOOT_SHAPE_WEST = Block.box(0, 0, 5, 16, 18, 16);

    private static final VoxelShape HEAD_SHAPE_NORTH = Block.box(0, 0, 0, 14, 18, 16);
    private static final VoxelShape HEAD_SHAPE_SOUTH = Block.box(0, 0, 0, 14, 18, 16);
    private static final VoxelShape HEAD_SHAPE_EAST = Block.box(0, 0, 5, 16, 18, 16);
    private static final VoxelShape HEAD_SHAPE_WEST = Block.box(0, 0, 5, 16, 18, 16);
    public RoadClosedBarricadeGuardrail4(BlockBehaviour.Properties properties) {
        super(properties);
