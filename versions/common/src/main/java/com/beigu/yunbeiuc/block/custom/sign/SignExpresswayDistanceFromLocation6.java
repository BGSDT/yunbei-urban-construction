...
public class SignExpresswayDistanceFromLocation6 extends EntityBlockCompat {
    ...
    public SignExpresswayDistanceFromLocation6(BlockBehaviour.Properties properties) {
        super(properties);
