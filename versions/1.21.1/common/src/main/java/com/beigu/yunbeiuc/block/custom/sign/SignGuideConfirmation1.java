...
import com.beigu.yunbeiuc.screen.SignGuideConfirmation1Screen;
...
public class SignGuideConfirmation1 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignGuideConfirmation1> CODEC = createCodec(SignGuideConfirmation1::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignGuideConfirmation1Screen(pos));
    }
