...
public class ZonesBoardOverWeight extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<ZonesBoardOverWeight> CODEC = createCodec(ZonesBoardOverWeight::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new ZonesBoardOverWeightScreen(pos));
    }
