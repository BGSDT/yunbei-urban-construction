...
import com.beigu.yunbeiuc.screen.SignGuideIntersectionAdvanceWarning6Screen;
...
public class SignGuideIntersectionAdvanceWarning6 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignGuideIntersectionAdvanceWarning6> CODEC = createCodec(SignGuideIntersectionAdvanceWarning6::new);
    ...
    public SignGuideIntersectionAdvanceWarning6(Settings settings) {
        super(settings);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignGuideIntersectionAdvanceWarning6Screen(pos));
    }
