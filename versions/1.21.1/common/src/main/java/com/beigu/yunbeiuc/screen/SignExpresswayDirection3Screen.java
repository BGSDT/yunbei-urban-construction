...
public class SignExpresswayDirection3Screen extends Screen {
    ...
    public SignExpresswayDirection3Screen(BlockPos pos) {
        super(Text.translatable("text.yunbeiuc.sign_expressway_direction_3.title"));
        this.pos = pos;
    }
    ...
    private TextFieldWidget createTextField(int x, int y, String existingText) {
        TextFieldWidget field = new TextFieldWidget(
                ...
                Text.translatable("text.yunbeiuc.sign_expressway_direction_3.content")
        );
        field.setMaxLength(256);
        field.setText(existingText);
        field.setPlaceholder(Text.translatable("text.yunbeiuc.sign_expressway_direction_3.placeholder"));
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredTextWithShadow(
                this.textRenderer,
                Text.translatable("text.yunbeiuc.sign_expressway_direction_3.title"),
    ...
    private void renderLabel(DrawContext context, int panelX, int panelY, String suffix, int yOffset, int xOffset) {
        context.drawTextWithShadow(
                this.textRenderer,
                Text.translatable("text.yunbeiuc.sign_expressway_direction_3." + suffix),
    ...
    private interface ExpresswayConsumer {
        void accept(SignExpresswayDirection3Entity.Expressway expressway);
    }
}