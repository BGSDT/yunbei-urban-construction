...
import com.beigu.yunbeiuc.screen.SignExpresswayDirection1Screen;
...
public class SignExpresswayDirection1 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignExpresswayDirection1> CODEC = createCodec(SignExpresswayDirection1::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignExpresswayDirection1Screen(pos));
    }
