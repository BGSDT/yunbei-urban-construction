...
import com.beigu.yunbeiuc.screen.SignGuideLaneIndicator1Screen;
...
public class SignGuideLaneIndicator1 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignGuideLaneIndicator1> CODEC = createCodec(SignGuideLaneIndicator1::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignGuideLaneIndicator1Screen(pos));
    }
