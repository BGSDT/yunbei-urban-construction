...
import com.beigu.yunbeiuc.screen.SignExpresswayEntranceAdvance10Screen;
...
public class SignExpresswayEntranceAdvance10 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignExpresswayEntranceAdvance10> CODEC = createCodec(SignExpresswayEntranceAdvance10::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignExpresswayEntranceAdvance10Screen(pos));
    }
