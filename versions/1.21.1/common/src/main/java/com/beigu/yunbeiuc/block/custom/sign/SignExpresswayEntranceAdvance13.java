...
import com.beigu.yunbeiuc.screen.SignExpresswayEntranceAdvance13Screen;
...
public class SignExpresswayEntranceAdvance13 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignExpresswayEntranceAdvance13> CODEC = createCodec(SignExpresswayEntranceAdvance13::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignExpresswayEntranceAdvance13Screen(pos));
    }
