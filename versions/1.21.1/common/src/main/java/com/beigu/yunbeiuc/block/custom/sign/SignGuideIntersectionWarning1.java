...
import com.beigu.yunbeiuc.screen.SignGuideIntersectionWarning1Screen;
...
public class SignGuideIntersectionWarning1 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignGuideIntersectionWarning1> CODEC = createCodec(SignGuideIntersectionWarning1::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignGuideIntersectionWarning1Screen(pos));
    }
