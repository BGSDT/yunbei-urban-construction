...
public class RoadClosedBarricadeGuardrail3 extends HorizontalFacingBlock {
    ...
    private static final VoxelShape FOOT_SHAPE_SOUTH = Block.createCuboidShape(5, 0, 0, 16, 18, 11);
    private static final VoxelShape FOOT_SHAPE_EAST = Block.createCuboidShape(0, 0, 5, 16, 18, 16);
    private static final VoxelShape FOOT_SHAPE_WEST = Block.createCuboidShape(5, 0, 0, 11, 18, 16);

    private static final VoxelShape HEAD_SHAPE_NORTH = Block.createCuboidShape(0, 0, 0, 11, 18, 16);
    private static final VoxelShape HEAD_SHAPE_SOUTH = Block.createCuboidShape(5, 0, 0, 16, 18, 11);
    private static final VoxelShape HEAD_SHAPE_EAST = Block.createCuboidShape(0, 0, 5, 11, 18, 16);
    private static final VoxelShape HEAD_SHAPE_WEST = Block.createCuboidShape(5, 0, 0, 16, 18, 11);
    public RoadClosedBarricadeGuardrail3(Settings settings) {
        super(settings);
