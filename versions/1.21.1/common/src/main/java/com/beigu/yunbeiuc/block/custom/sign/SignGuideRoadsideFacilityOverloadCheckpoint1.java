...
import com.beigu.yunbeiuc.screen.SignGuideRoadsideFacilityOverloadCheckpoint1Screen;
...
public class SignGuideRoadsideFacilityOverloadCheckpoint1 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignGuideRoadsideFacilityOverloadCheckpoint1> CODEC = createCodec(SignGuideRoadsideFacilityOverloadCheckpoint1::new);
    ...
    public void appendTooltip(ItemStack stack, Item.TooltipContext context, List<Text> tooltip, TooltipType options) {
        tooltip.add(Text.translatable("block.yunbeiuc.sign_guide_roadside_facility_overload_checkpoint_1.tooltip"));
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignGuideRoadsideFacilityOverloadCheckpoint1Screen(pos));
    }
