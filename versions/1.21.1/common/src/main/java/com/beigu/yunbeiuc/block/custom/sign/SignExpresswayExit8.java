...
import com.beigu.yunbeiuc.screen.SignExpresswayExit8Screen;
...
public class SignExpresswayExit8 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignExpresswayExit8> CODEC = createCodec(SignExpresswayExit8::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignExpresswayExit8Screen(pos));
    }
