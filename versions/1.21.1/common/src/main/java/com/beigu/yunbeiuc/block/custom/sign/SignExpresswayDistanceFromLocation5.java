...
import com.beigu.yunbeiuc.screen.SignExpresswayDistanceFromLocation5Screen;
...
public class SignExpresswayDistanceFromLocation5 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignExpresswayDistanceFromLocation5> CODEC = createCodec(SignExpresswayDistanceFromLocation5::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignExpresswayDistanceFromLocation5Screen(pos));
    }
