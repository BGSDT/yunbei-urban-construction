...
public class SignExpresswayEntranceAdvance7 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignExpresswayEntranceAdvance7> CODEC = createCodec(SignExpresswayEntranceAdvance7::new);
