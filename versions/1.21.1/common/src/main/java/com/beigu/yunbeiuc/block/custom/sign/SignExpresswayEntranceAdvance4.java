...
import com.beigu.yunbeiuc.screen.SignExpresswayEntranceAdvance4Screen;
...
public class SignExpresswayEntranceAdvance4 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignExpresswayEntranceAdvance4> CODEC = createCodec(SignExpresswayEntranceAdvance4::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignExpresswayEntranceAdvance4Screen(pos));
    }
