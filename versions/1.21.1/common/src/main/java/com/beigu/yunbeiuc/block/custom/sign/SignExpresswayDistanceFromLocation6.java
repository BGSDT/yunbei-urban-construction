...
public class SignExpresswayDistanceFromLocation6 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignExpresswayDistanceFromLocation6> CODEC = createCodec(SignExpresswayDistanceFromLocation6::new);
