...
import com.beigu.yunbeiuc.screen.SignExpresswayDistanceFromLocation1Screen;
...
public class SignExpresswayDistanceFromLocation1 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignExpresswayDistanceFromLocation1> CODEC = createCodec(SignExpresswayDistanceFromLocation1::new);
    ...
    public SignExpresswayDistanceFromLocation1(Settings settings) {
        super(settings);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignExpresswayDistanceFromLocation1Screen(pos));
    }
