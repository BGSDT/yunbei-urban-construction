...
public class SignExpresswayRoadNameScreen extends Screen {
    ...
    public SignExpresswayRoadNameScreen(BlockPos pos) {
        super(Text.translatable("text.yunbeiuc.sign_expressway_road_name.title"));
        this.pos = pos;
    }
    ...
    private TextFieldWidget createTextField(int x, int y, String existingText) {
        TextFieldWidget field = new TextFieldWidget(
                ...
                Text.translatable("text.yunbeiuc.sign_expressway_road_name.content")
        );
        field.setMaxLength(256);
        field.setText(existingText);
        field.setPlaceholder(Text.translatable("text.yunbeiuc.sign_expressway_road_name.placeholder"));
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredTextWithShadow(
                this.textRenderer,
                Text.translatable("text.yunbeiuc.sign_expressway_road_name.title"),
