...
public class SignExpresswayDirection5EntityRenderer implements BlockEntityRenderer<SignExpresswayDirection5Entity> {
    ...
    public void render(SignExpresswayDirection5Entity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        if (currentBlock == SignBlocks.SIGN_EXPRESSWAY_DIRECTION_5.get()){
            renderExpresswayLogo(matrices, vertexConsumers, light, overlay, facing, expressway1, 4.5f, 7f, type, expresswayNumber1);
            renderText(matrices, vertexConsumers, light, facing, text1, type, 4.5f, -7f, 0XFFFFFF);
            renderExpresswayText(matrices, vertexConsumers, light, facing, expresswayNumber1, type, 4.5f, 6.5f);
            renderDirectionLogo(matrices, vertexConsumers, light, overlay, facing, direction1, -8.5f, 8.5f, type);
    ...
    private void renderDirectionLogo(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay, Direction facing, SignExpresswayDirection5Entity.Direction direction, float andX, float andY, SignExpresswayDirection5.Type type) {
    ...
    private void renderExpresswayLogo(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay, Direction facing, SignExpresswayDirection5Entity.Expressway expressway, float andX, float andY, SignExpresswayDirection5.Type type, String expresswayNumber) {
    ...
    private void renderText(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, Direction facing, String text, SignExpresswayDirection5.Type type, float andX, float andY, int color) {
        matrices.push();
        matrices.translate(0.5, 0.5, 0.5);
        matrices.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(-facing.asRotation()));
    ...
    private void renderExpresswayText(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, Direction facing, String text, SignExpresswayDirection5.Type type, float andX, float andY) {
        matrices.push();
        matrices.translate(0.5, 0.5, 0.5);
        matrices.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(-facing.asRotation()));
