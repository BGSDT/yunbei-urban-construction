...
public class SignExpresswayEntranceAdvance1EntityRenderer extends AbstractTextDisplayEntityRenderer<SignExpresswayEntranceAdvance1Entity> {
    ...
    @Override
    protected void applyTransforms(MatrixStack matrices, SignExpresswayEntranceAdvance1Entity entity) {
    ...
    protected float getZOffset(SignExpresswayEntranceAdvance1Entity entity) {
        return switch (SignTypeConverter.convert(entity.getCachedState().get(SignExpresswayEntranceAdvance1.TYPE))) {
            case POLE_L -> -0.74f;
            case POLE_H -> -0.81f;
            case NORMAL -> -0.45f;
        };
