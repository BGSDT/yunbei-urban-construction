...
public class CaltropBlock extends Block {
    public CaltropBlock(Settings settings) {
        super(settings);
    ...
    private static final VoxelShape SHAPE_N = Block.createCuboidShape(0, 0, -2, 16, 25, 18);
    private static final VoxelShape SHAPE_E = Block.createCuboidShape(-2, 0, 0, 18, 25, 16);
    private static final VoxelShape SHAPE_S = Block.createCuboidShape(0, 0, -18, 16, 25, 2);
    private static final VoxelShape SHAPE_W = Block.createCuboidShape(-18, 0, 0, 2, 25, 16);
