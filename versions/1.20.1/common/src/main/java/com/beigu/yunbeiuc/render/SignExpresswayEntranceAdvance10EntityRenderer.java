...
public class SignExpresswayEntranceAdvance10EntityRenderer implements BlockEntityRenderer<SignExpresswayEntranceAdvance10Entity> {
    ...
    public void render(SignExpresswayEntranceAdvance10Entity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        renderExpresswayLogo(matrices, vertexConsumers, light, overlay, facing, expressway1, -6f, 7f, type, expresswayNumber1);
        renderExpresswayLogo(matrices, vertexConsumers, light, overlay, facing, expressway2, 6f, 7f, type, expresswayNumber2);
        renderExpresswayText(matrices, vertexConsumers, light, facing, expresswayNumber1, type, -6f, 6.5f);
        renderExpresswayText(matrices, vertexConsumers, light, facing, expresswayNumber2, type, 6f, 6.5f);
    ...
    private void renderExpresswayLogo(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay, Direction facing, SignExpresswayEntranceAdvance10Entity.Expressway expressway, float andX, float andY, SignExpresswayEntranceAdvance10.Type type, String expresswayNumber) {
    ...
    private void renderText(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, Direction facing, String text, SignExpresswayEntranceAdvance10.Type type, float andX, float andY, int color) {
        matrices.push();
    ...
    private void renderExpresswayText(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, Direction facing, String text, SignExpresswayEntranceAdvance10.Type type, float andX, float andY) {
        matrices.push();
    ...
    @Override
    public boolean rendersOutsideBoundingBox(SignExpresswayEntranceAdvance10Entity blockEntity) {
        return true;
    }
