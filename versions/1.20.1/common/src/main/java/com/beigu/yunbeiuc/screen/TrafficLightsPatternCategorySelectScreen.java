...
public class TrafficLightsPatternCategorySelectScreen extends Screen {
    ...
    protected void init() {
        ...
        this.enterButton = ButtonWidget.builder(Text.literal("进入分类"), button -> enterCategory())
        ...
        this.addDrawableChild(
                ButtonWidget.builder(Text.literal("新建分类"), button ->
                        MinecraftClient.getInstance().setScreen(new TrafficLightsPatternCategoryEditorScreen(this)))
                        .dimensions(panelX + 20, panelY + 78, buttonWidth, 20)
                        .build()
        );

        this.deleteButton = ButtonWidget.builder(Text.literal("删除分类"), button -> deleteCategory())
    ...
    private void enterCategory() {
        ...
        MinecraftClient.getInstance().setScreen(new TrafficLightsPatternSelectScreen(pos, selectedCategory, this));
    }
