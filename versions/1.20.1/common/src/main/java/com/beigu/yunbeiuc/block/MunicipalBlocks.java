...
public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(YunbeiUrbanConstruction.MOD_ID, RegistryKeys.BLOCK);
    ...
    public static final RegistrySupplier<Block> TRAFFIC_LIGHTS_GRAY_VERTICAL = BLOCKS.register("traffic_lights_gray_vertical", () -> new TrafficLightsBlock(AbstractBlock.Settings.create().strength(1.25F, 4.2F).luminance(state -> 15).requiresTool()));
    ...
    public static final RegistrySupplier<Block> TRAFFIC_LIGHTS_YELLOW_VERTICAL = BLOCKS.register("traffic_lights_yellow_vertical", () -> new TrafficLightsBlock(AbstractBlock.Settings.create().strength(1.25F, 4.2F).luminance(state -> 15).requiresTool()));
    ...
    public static final RegistrySupplier<Block> TRAFFIC_LIGHTS_PAVEMENT_BLACK = BLOCKS.register("traffic_lights_pavement_black", () -> new TrafficLightsBlock(AbstractBlock.Settings.create().strength(1.25F, 4.2F).luminance(state -> 15).requiresTool()));
    public static final RegistrySupplier<Block> TRAFFIC_LIGHTS_PAVEMENT_INTEGRATION_GRAY = BLOCKS.register("traffic_lights_pavement_integration_gray", () -> new com.beigu.yunbeiuc.block.custom.traffic.TrafficLightsPavementIntegrationBlock(AbstractBlock.Settings.create().strength(1.25F, 4.2F).luminance(state -> 15).requiresTool().nonOpaque()));
    ...
    public static final RegistrySupplier<Block> TRAFFIC_LIGHTS_GREEN_TAIPEI = BLOCKS.register("traffic_lights_green_taipei", () -> new TrafficLightsBlock(AbstractBlock.Settings.create().strength(1.25F, 4.2F).luminance(state -> 15).requiresTool()));
    public static final RegistrySupplier<Block> TRAFFIC_LIGHTS_PAVEMENT_GREEN_TAIPEI = BLOCKS.register("traffic_lights_pavement_green_taipei", () -> new TrafficLightsBlock(AbstractBlock.Settings.create().strength(1.25F, 4.2F).luminance(state -> 15).requiresTool()));
