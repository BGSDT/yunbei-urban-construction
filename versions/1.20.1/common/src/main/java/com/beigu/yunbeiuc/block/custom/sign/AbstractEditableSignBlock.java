...
public abstract class AbstractEditableSignBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public AbstractEditableSignBlock(Settings settings) {
        super(settings);
