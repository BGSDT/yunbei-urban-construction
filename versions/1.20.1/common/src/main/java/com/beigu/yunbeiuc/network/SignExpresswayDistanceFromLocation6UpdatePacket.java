...
public class SignExpresswayDistanceFromLocation6UpdatePacket {
    ...
    private final SignExpresswayDistanceFromLocation6Entity.Expressway expressway1;
    private final SignExpresswayDistanceFromLocation6Entity.Expressway expressway2;
    private final String expresswayNumber1;
    private final String expresswayNumber2;

    public SignExpresswayDistanceFromLocation6UpdatePacket(BlockPos pos, String text1, String text2, String text3, String length1, String length2, String length3, SignExpresswayDistanceFromLocation6Entity.Expressway expressway1, SignExpresswayDistanceFromLocation6Entity.Expressway expressway2, String expresswayNumber1, String expresswayNumber2) {
        this.pos = pos;
        this.text1 = text1;
        this.text2 = text2;
        this.text3 = text3;
    ...
    public SignExpresswayDistanceFromLocation6UpdatePacket(PacketByteBuf buf) {
        ...
        this.expressway1 = buf.readEnumConstant(SignExpresswayDistanceFromLocation6Entity.Expressway.class);
        this.expressway2 = buf.readEnumConstant(SignExpresswayDistanceFromLocation6Entity.Expressway.class);
