...
public class SignExpresswayNamingNumberEntity extends CustomSignBlockEntity {
    ...
    private void ensureDefaultTextLines() {
        ...
        lines.add(SignTextLinesHelper.centered("{expresswayNumber}", 0f, 1.5f, 0.08f, 0xFFFFFF));
        lines.add(SignTextLinesHelper.centered("{expresswayNameSpaced}", 0f, -6.5f, 0.02f, 0xFFFFFF));
        setTextLines(lines);
    }
