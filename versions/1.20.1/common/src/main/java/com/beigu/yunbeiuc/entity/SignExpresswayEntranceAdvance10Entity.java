...
public class SignExpresswayEntranceAdvance10Entity extends CustomSignBlockEntity {
    ...
    private void ensureDefaultTextLines() {
        ...
        lines.add(SignTextLinesHelper.centeredWithZ("{expresswayNumber1}", -6f, 6.5f, 0.045f, 0xFFFFFF, 0.002f));
        lines.add(SignTextLinesHelper.centeredWithZ("{expresswayNumber2}", 6f, 6.5f, 0.045f, 0xFFFFFF, 0.002f));
