...
public class DirectionSlabBlock extends Block implements Waterloggable {
    ...
    public DirectionSlabBlock(Settings settings) {
        super(settings);
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        if (blockState.isOf(this)) {
            return blockState.with(TYPE, SlabType.DOUBLE)
                    .with(WATERLOGGED, false)
                    .with(FACING, blockState.get(FACING)); // 保持原有朝向
        } else {
