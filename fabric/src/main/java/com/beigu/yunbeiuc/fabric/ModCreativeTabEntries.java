...
public class ModCreativeTabEntries {
    ...
    public static void register() {
        ...
        ItemGroupEvents.modifyEntriesEvent(
                RegistryKey.of(RegistryKeys.ITEM_GROUP, Identifier.of(YunbeiUrbanConstruction.MOD_ID, "municipal"))
        ).register(entries -> {
        ...
        // Road tab
        ItemGroupEvents.modifyEntriesEvent(
                RegistryKey.of(RegistryKeys.ITEM_GROUP, Identifier.of(YunbeiUrbanConstruction.MOD_ID, "rb"))
        ).register(entries -> {
        ...
        ItemGroupEvents.modifyEntriesEvent(
                RegistryKey.of(RegistryKeys.ITEM_GROUP, Identifier.of(YunbeiUrbanConstruction.MOD_ID, "sign"))
        ).register(entries -> {
        ...
        ItemGroupEvents.modifyEntriesEvent(
                RegistryKey.of(RegistryKeys.ITEM_GROUP, Identifier.of(YunbeiUrbanConstruction.MOD_ID, "wand"))
        ).register(entries -> {
