...
public class ZonesBoardImage extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<ZonesBoardImage> CODEC = createCodec(ZonesBoardImage::new);
