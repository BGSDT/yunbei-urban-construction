...
import com.beigu.yunbeiuc.screen.SignExpresswayDistanceFromLocation4Screen;
...
public class SignExpresswayDistanceFromLocation4 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignExpresswayDistanceFromLocation4> CODEC = createCodec(SignExpresswayDistanceFromLocation4::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignExpresswayDistanceFromLocation4Screen(pos));
    }
