...
import com.beigu.yunbeiuc.screen.ZonesBoardTimeRange2Screen;
...
public class ZonesBoardTimeRange2 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<ZonesBoardTimeRange2> CODEC = createCodec(ZonesBoardTimeRange2::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new ZonesBoardTimeRange2Screen(pos));
    }
