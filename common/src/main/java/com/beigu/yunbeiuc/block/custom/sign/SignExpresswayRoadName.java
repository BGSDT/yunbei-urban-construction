...
import com.beigu.yunbeiuc.screen.SignExpresswayRoadNameScreen;
...
public class SignExpresswayRoadName extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignExpresswayRoadName> CODEC = createCodec(SignExpresswayRoadName::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignExpresswayRoadNameScreen(pos));
    }
