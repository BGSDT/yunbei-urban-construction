...
import com.beigu.yunbeiuc.screen.SignExpresswayNamingNumberScreen;
...
public class SignExpresswayNamingNumber extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignExpresswayNamingNumber> CODEC = createCodec(SignExpresswayNamingNumber::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignExpresswayNamingNumberScreen(pos));
    }
