...
import com.beigu.yunbeiuc.screen.SignGuideIntersectionAdvanceWarning7Screen;
...
public class SignGuideIntersectionAdvanceWarning7 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignGuideIntersectionAdvanceWarning7> CODEC = createCodec(SignGuideIntersectionAdvanceWarning7::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignGuideIntersectionAdvanceWarning7Screen(pos));
    }
