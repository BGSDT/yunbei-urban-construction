...
import com.beigu.yunbeiuc.screen.SignGuideIntersectionAdvanceWarning5Screen;
...
public class SignGuideIntersectionAdvanceWarning5 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignGuideIntersectionAdvanceWarning5> CODEC = createCodec(SignGuideIntersectionAdvanceWarning5::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignGuideIntersectionAdvanceWarning5Screen(pos));
    }
