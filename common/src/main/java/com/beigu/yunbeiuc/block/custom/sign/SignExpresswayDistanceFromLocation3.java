...
import com.beigu.yunbeiuc.screen.SignExpresswayDistanceFromLocation3Screen;
...
public class SignExpresswayDistanceFromLocation3 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignExpresswayDistanceFromLocation3> CODEC = createCodec(SignExpresswayDistanceFromLocation3::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignExpresswayDistanceFromLocation3Screen(pos));
    }
