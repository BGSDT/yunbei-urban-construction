...
public class ZonesBoardTimeRange1 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<ZonesBoardTimeRange1> CODEC = createCodec(ZonesBoardTimeRange1::new);
