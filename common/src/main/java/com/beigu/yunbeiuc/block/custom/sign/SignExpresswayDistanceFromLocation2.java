...
import com.beigu.yunbeiuc.screen.SignExpresswayDistanceFromLocation2Screen;
...
public class SignExpresswayDistanceFromLocation2 extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<SignExpresswayDistanceFromLocation2> CODEC = createCodec(SignExpresswayDistanceFromLocation2::new);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        MinecraftClient.getInstance().setScreen(new SignExpresswayDistanceFromLocation2Screen(pos));
    }
