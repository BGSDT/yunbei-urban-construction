...
public class SignExpresswayEntranceAdvance4EntityRenderer implements BlockEntityRenderer<SignExpresswayEntranceAdvance4Entity> {
    ...
    public void render(SignExpresswayEntranceAdvance4Entity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        renderExpresswayLogo(matrices, vertexConsumers, light, overlay, facing, expressway1, -3f, 7f, type, expresswayNumber1);
        renderDirectionLogo(matrices, vertexConsumers, light, overlay, facing, direction1, 6f, 7f, type);
        renderText(matrices, vertexConsumers, light, facing, text1 + "方向", type, 0f, -2f, 0XFFFFFF);
        renderExpresswayText(matrices, vertexConsumers, light, facing, expresswayNumber1, type, -3f, 6.5f);
    }

    private void renderDirectionLogo(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay, Direction facing, SignExpresswayEntranceAdvance4Entity.Direction direction, float andX, float andY, SignExpresswayEntranceAdvance4.Type type) {
    ...
    private void renderExpresswayLogo(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay, Direction facing, SignExpresswayEntranceAdvance4Entity.Expressway expressway, float andX, float andY, SignExpresswayEntranceAdvance4.Type type, String expresswayNumber) {
    ...
    private void renderText(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, Direction facing, String text, SignExpresswayEntranceAdvance4.Type type, float andX, float andY, int color) {
        matrices.push();
    ...
    private void renderExpresswayText(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, Direction facing, String text, SignExpresswayEntranceAdvance4.Type type, float andX, float andY) {
        matrices.push();
