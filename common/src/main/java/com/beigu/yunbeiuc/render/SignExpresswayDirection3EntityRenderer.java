...
public class SignExpresswayDirection3EntityRenderer implements BlockEntityRenderer<SignExpresswayDirection3Entity> {
    ...
    private void renderExpresswayLogo(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay, Direction facing, SignExpresswayDirection3Entity.Expressway expressway, float andX, float andY, SignExpresswayDirection3.Type type, String expresswayNumber) {
    ...
    private void renderText(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, Direction facing, String text, SignExpresswayDirection3.Type type, float andX, float andY, int color) {
        matrices.push();
        matrices.translate(0.5, 0.5, 0.5);
        matrices.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(-facing.asRotation()));
    ...
    private void renderExpresswayText(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, Direction facing, String text, SignExpresswayDirection3.Type type, float andX, float andY) {
        matrices.push();
        matrices.translate(0.5, 0.5, 0.5);
        matrices.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(-facing.asRotation()));
    ...
    @Override
    public boolean rendersOutsideBoundingBox(SignExpresswayDirection3Entity blockEntity) {
        return true;
    }
