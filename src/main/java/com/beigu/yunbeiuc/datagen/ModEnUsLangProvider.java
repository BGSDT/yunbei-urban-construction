...
public class ModEnUsLangProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(SignBlocks.ZONES_BOARD_ARROW_LEFT, "Left Direction Zone Sign");
        translationBuilder.add(SignBlocks.ZONES_BOARD_ARROW_RIGHT, "Right Direction Zone Sign");
        translationBuilder.add(SignBlocks.ZONES_BOARD_TWO_WAY, "Two-Way Zone Sign");
        translationBuilder.add(SignBlocks.ZONES_BOARD_RED, "National Highway Number Zone Sign");
        translationBuilder.add(SignBlocks.ZONES_BOARD_YELLOW, "Provincial Highway Number Zone Sign");
        translationBuilder.add(SignBlocks.ZONES_BOARD_WHITE, "County & Township Road Number Zone Sign");
        translationBuilder.add("text.yunbeiuc.zones_board_1.title", "Zone Sign Text Settings");
        translationBuilder.add("text.yunbeiuc.zones_board_1.content", "Display Content");
        translationBuilder.add("text.yunbeiuc.zones_board_1.placeholder", "Enter display text...");
        translationBuilder.add("text.yunbeiuc.zones_board_1.save", "Save");
        translationBuilder.add("text.yunbeiuc.zones_board_1.cancel", "Cancel");
        translationBuilder.add("text.yunbeiuc.zones_board_1.text_1_name", "Number");
        translationBuilder.add(SignBlocks.ZONES_BOARD_IMAGE, "Image Zone Sign");
        translationBuilder.add("block.yunbeiuc.zones_board.tooltip", "Right-click with the wand to edit the zone sign");
        translationBuilder.add("text.yunbeiuc.zones_board_image.title", "Zone Sign Settings");
        translationBuilder.add("text.yunbeiuc.zones_board_image.settings_title", "Sign Settings");
        translationBuilder.add("text.yunbeiuc.zones_board_image.text1_label", "Text Content:");
        translationBuilder.add("text.yunbeiuc.zones_board_image.text1_content", "Display Content");
        translationBuilder.add("text.yunbeiuc.zones_board_image.text1_placeholder", "Enter display text...");
        translationBuilder.add("text.yunbeiuc.zones_board_image.offset_label", "Offset:");
        translationBuilder.add("text.yunbeiuc.zones_board_image.offset_value", "X：%s Y：%s");
        translationBuilder.add("text.yunbeiuc.zones_board_image.scale_label", "Scale:");
        translationBuilder.add("text.yunbeiuc.zones_board_image.scale_value", "Scale: %s");
        translationBuilder.add("text.yunbeiuc.zones_board_image.current_selection", "Current Selection: %s");
        translationBuilder.add("text.yunbeiuc.zones_board_image.current_offset", "X: %s Y: %s");
        translationBuilder.add("text.yunbeiuc.zones_board_image.save", "Save");
        translationBuilder.add("text.yunbeiuc.zones_board_image.cancel", "Cancel");
        translationBuilder.add("text.yunbeiuc.zones_board_image.road_type.national", "National Road");
        translationBuilder.add("text.yunbeiuc.zones_board_image.road_type.provincial", "Provincial Road");
        translationBuilder.add("text.yunbeiuc.zones_board_image.road_type.county", "County/Township Road");
        translationBuilder.add("text.yunbeiuc.zones_board_image.road_type.expressway", "Expressway");
        ...
        translationBuilder.add("block.yunbeiuc.sign_guide_intersection_advance_warning.tooltip", "Right-click with the wand to edit intersection advance warning sign text");
        ...
        translationBuilder.add(SignBlocks.SIGN_GUIDE_INTERSECTION_ADVANCE_WARNING_1, "Intersection Advance Warning Sign 1 (Graphic)");
        translationBuilder.add(SignBlocks.SIGN_GUIDE_INTERSECTION_ADVANCE_WARNING_2, "Intersection Advance Warning Sign 2 (Graphic)");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_1.title", "Warning Sign Text Display Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_1.content", "Display Content");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_1.placeholder", "Enter display text...");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_1.save", "Save");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_1.cancel", "Cancel");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_1.text_1_name", "Text Above Arrow");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_1.text_2_name", "Text Right of Arrow");
        translationBuilder.add(SignBlocks.SIGN_GUIDE_INTERSECTION_ADVANCE_WARNING_3, "Intersection Advance Warning Sign 3 (Text)");
        translationBuilder.add(SignBlocks.SIGN_GUIDE_INTERSECTION_ADVANCE_WARNING_4, "Intersection Advance Warning Sign 4 (Graphic & Text)");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.title", "Warning Sign Text Display Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.content", "Display Content");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.placeholder", "Enter display text...");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.save", "Save");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.cancel", "Cancel");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.text_1_name", "Current Road Name Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.cn_text_2_name", "Straight Road 1 Chinese Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.en_text_2_name", "Straight Road 1 English Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.cn_text_3_name", "Straight Road 2 Chinese Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.en_text_3_name", "Straight Road 2 English Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.cn_text_4_name", "Left Turn Road 1 Chinese Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.en_text_4_name", "Left Turn Road 1 English Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.cn_text_5_name", "Left Turn Road 2 Chinese Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.en_text_5_name", "Left Turn Road 2 English Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.cn_text_6_name", "Right Turn Road 1 Chinese Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.en_text_6_name", "Right Turn Road 1 English Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.cn_text_7_name", "Right Turn Road 2 Chinese Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_3.en_text_7_name", "Right Turn Road 2 English Text");
        translationBuilder.add(SignBlocks.SIGN_GUIDE_INTERSECTION_ADVANCE_WARNING_5, "Intersection Advance Warning Sign 5");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_5.title", "Warning Sign Text Display Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_5.content", "Display Content");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_5.placeholder", "Enter display text...");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_5.save", "Save");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_5.cancel", "Cancel");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_5.text_1_name", "Road 1 Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_5.text_2_name", "Road 2 Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_5.text_3_name", "Road 3 Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_5.text_4_name", "Road 4 Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_5.y_value", "YOffset: %s");
        translationBuilder.add(SignBlocks.SIGN_GUIDE_LANE_INDICATOR_1, "Guide Lane Indicator Sign 1");
        translationBuilder.add("text.yunbeiuc.sign_guide_lane_indicator_1.title", "Lane Direction Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_lane_indicator_1.save", "Save");
        translationBuilder.add("text.yunbeiuc.sign_guide_lane_indicator_1.cancel", "Cancel");
        translationBuilder.add("text.yunbeiuc.sign_guide_lane_indicator_1.direction_1", "Lane 1 Direction Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_lane_indicator_1.direction_2", "Lane 2 Direction Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_lane_indicator_1.direction_3", "Lane 3 Direction Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_lane_indicator_1.direction_4", "Lane 4 Direction Settings");
        translationBuilder.add("text.yunbeiuc.direction.left", "Left");
        translationBuilder.add("text.yunbeiuc.direction.straight", "Straight");
        translationBuilder.add("text.yunbeiuc.direction.right", "Right");
        translationBuilder.add(SignBlocks.SIGN_GUIDE_INTERSECTION_ADVANCE_WARNING_6, "Intersection Advance Warning Sign 6");
        translationBuilder.add(SignBlocks.SIGN_GUIDE_INTERSECTION_ADVANCE_WARNING_8, "Intersection Advance Warning Sign 8");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_6.title", "Warning Sign Text Display Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_6.content", "Display Content");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_6.placeholder", "Enter display text...");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_6.save", "Save");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_6.cancel", "Cancel");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_6.1_name", "Direction 1 Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_6.2_name", "Direction 2 Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_6.text_1_name", "Road 1 Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_6.text_2_name", "Road 2 Text");
        translationBuilder.add(SignBlocks.SIGN_GUIDE_INTERSECTION_ADVANCE_WARNING_7, "Intersection Advance Warning Sign 7");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_7.title", "Sign Text Display Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_7.content", "Display Content");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_7.placeholder", "Enter display text...");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_7.save", "Save");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_7.cancel",    "Cancel");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_7.1_name", "Direction 1 Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_7.2_name", "Direction 2 Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_7.3_name", "Direction 3 Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_7.text_1_name", "Road 1 Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_7.text_2_name", "Road 2 Text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_advance_warning_7.text_3_name", "Road 3 Text");

        translationBuilder.add(SignBlocks.SIGN_GUIDE_INTERSECTION_WARNING_1, "Intersection Warning / Place name / Boundary Sign 1");
        translationBuilder.add(SignBlocks.SIGN_GUIDE_INTERSECTION_WARNING_2, "Intersection Warning Sign 2");
        translationBuilder.add(SignBlocks.SIGN_GUIDE_INTERSECTION_WARNING_3, "Intersection Warning Sign 3");
        translationBuilder.add(SignBlocks.SIGN_GUIDE_INTERSECTION_WARNING_5, "Intersection Warning Sign 5");
        translationBuilder.add(SignBlocks.SIGN_GUIDE_INTERSECTION_WARNING_6, "Intersection Warning / Place name / Boundary Sign 6");
        translationBuilder.add("block.yunbeiuc.sign_guide_intersection_warning.tooltip", "Right-click with the wand to edit intersection warning / place name /boundary sign text");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_warning_1.title", "Warning Sign Text Display Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_warning_1.content", "Display Content");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_warning_1.placeholder", "Enter display text...");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_warning_1.save", "Save");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_warning_1.cancel", "Cancel");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_warning_1.text_1_name", "Road Text");
        translationBuilder.add(SignBlocks.SIGN_GUIDE_INTERSECTION_WARNING_4, "Intersection Warning Sign 4");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_warning_4.title", "Warning Sign Text Display Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_warning_4.content", "Display Content");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_warning_4.placeholder", "Enter display text...");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_warning_4.save", "Save");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_warning_4.cancel", "Cancel");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_warning_4.1_name", "Direction Select");
        translationBuilder.add("text.yunbeiuc.sign_guide_intersection_warning_4.text_1_name", "Road Text");

        translationBuilder.add(SignBlocks.SIGN_GUIDE_CONFIRMATION_1,"Confirmation Sign 1");
        translationBuilder.add(SignBlocks.SIGN_GUIDE_CONFIRMATION_2,"Confirmation Sign 2");
        translationBuilder.add("block.yunbeiuc.sign_guide_confirmation.tooltip","Right-click with the wand to edit confirmation sign text");
        translationBuilder.add("text.yunbeiuc.sign_guide_confirmation_1.title", "Confirmation Sign Text Display Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_confirmation_1.save", "Save");
        translationBuilder.add("text.yunbeiuc.sign_guide_confirmation_1.cancel", "Cancel");
        translationBuilder.add("text.yunbeiuc.sign_guide_confirmation_1.1_name", "Line 1 Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_confirmation_1.2_name", "Line 2 Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_confirmation_1.3_name", "Line 3 Settings");
        translationBuilder.add("text.yunbeiuc.sign_guide_confirmation_1.text_1", "Location 1");
        translationBuilder.add("text.yunbeiuc.sign_guide_confirmation_1.text_2", "Location 2");
        translationBuilder.add("text.yunbeiuc.sign_guide_confirmation_1.text_3", "Location 3");
        translationBuilder.add("text.yunbeiuc.sign_guide_confirmation_1.length_1", "Distance 1");
        translationBuilder.add("text.yunbeiuc.sign_guide_confirmation_1.length_2", "Distance 2");
        translationBuilder.add("text.yunbeiuc.sign_guide_confirmation_1.length_3", "Distance 3");
        translationBuilder.add("text.yunbeiuc.sign_guide_confirmation_1.placeholder", "Enter display text...");
        translationBuilder.add("text.yunbeiuc.unit.metre", "m");
        ...
        translationBuilder.add("text.yunbeiuc.sign_expressway_exit_8.save", "Save");
        translationBuilder.add("text.yunbeiuc.sign_expressway_exit_8.cancel", "Cancel");
        translationBuilder.add("text.yunbeiuc.sign_expressway_exit_8.1_name", "Exit 1 Direction Settings");
        translationBuilder.add("text.yunbeiuc.sign_expressway_exit_8.2_name", "Exit 2 Direction Settings");
        translationBuilder.add("text.yunbeiuc.sign_expressway_exit_8.expressway_number_1_name", "Expressway Number 1");
        translationBuilder.add("text.yunbeiuc.sign_expressway_exit_8.expressway_number_2_name", "Expressway Number 2");
        translationBuilder.add("text.yunbeiuc.sign_expressway_exit_8.text_1_name", "Exit 1 Text");
        translationBuilder.add("text.yunbeiuc.sign_expressway_exit_8.text_2_name", "Exit 2 Text");
        translationBuilder.add("text.yunbeiuc.sign_expressway_exit_8.exit_number_name", "Exit Number");
        translationBuilder.add("text.yunbeiuc.direction.north", "North");
        translationBuilder.add("text.yunbeiuc.direction.south", "South");
        translationBuilder.add("text.yunbeiuc.direction.west", "West");
        translationBuilder.add("text.yunbeiuc.direction.east", "East");
        translationBuilder.add("text.yunbeiuc.expressway.national", "National Expressway");
        translationBuilder.add("text.yunbeiuc.expressway.provincial", "Provincial Expressway");
