...
public class SignGuideIntersectionAdvanceWarning6Entity extends BlockEntity {
    ...
    public SignGuideIntersectionAdvanceWarning6Entity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.SIGN_GUIDE_INTERSECTION_ADVANCE_WARNING_6_ENTITY, pos, state);
    }
