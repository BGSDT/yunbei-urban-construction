...
public class ZonesBoard2Entity extends BlockEntity {
    ...
    public ZonesBoard2Entity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.ZONES_BOARD_2_ENTITY, pos, state);
    }
