...
public class SignGuideIntersectionAdvanceWarning1Screen extends Screen {
    ...
    protected void init() {
        ...
        this.text1TextField.setPlaceholder(Text.translatable("text.yunbeiuc.sign_guide_intersection_advance_warning_1.placeholder"));
        ...
        this.text2TextField.setPlaceholder(Text.translatable("text.yunbeiuc.sign_guide_intersection_advance_warning_1.placeholder"));
