...
import com.beigu.yunbeiuc.network.ZonesBoard2UpdatePacket;
...
public class ZonesBoard2Screen extends Screen {
    private final BlockPos pos;
    private final ZonesBoard2Entity blockEntity;
    ...
    protected void init() {
        ...
        if (this.client != null && this.client.world != null) {
            if (this.client.world.getBlockEntity(this.pos) instanceof ZonesBoard2Entity entity) {
...
// 缩放按钮
    ...
    private void saveAndClose() {
        if (this.client != null && this.client.world != null) {
            ...
            ZonesBoard2Entity.BoardImage selectedImage = selectedOption != null ? selectedOption.getImage() : ZonesBoard2Entity.BoardImage.RED;

            ZonesBoard2UpdatePacket packet =
                    new ZonesBoard2UpdatePacket(pos, text1, selectedImage, andX, andY, andScale);
            PacketByteBuf buf = new PacketByteBuf(Unpooled.buffer());
            packet.write(buf);
            ClientPlayNetworking.send(ModMessages.UPDATE_ZONES_BOARD_2, buf);
        }
        this.close();
    }
    ...
    private List<ImageOption> createImageOptions() {
        ...
        options.add(new ImageOption(ZonesBoard2Entity.BoardImage.RED, RED_TEXTURE,
                "text.yunbeiuc.zones_board_image.road_type.national"));
        options.add(new ImageOption(ZonesBoard2Entity.BoardImage.YELLOW, YELLOW_TEXTURE,
                "text.yunbeiuc.zones_board_image.road_type.provincial"));
        options.add(new ImageOption(ZonesBoard2Entity.BoardImage.WHITE, WHITE_TEXTURE,
                "text.yunbeiuc.zones_board_image.road_type.county"));
        options.add(new ImageOption(ZonesBoard2Entity.BoardImage.EXPRESSWAY, EXPRESSWAY_TEXTURE,
    ...
    private static class ImageOption {
        private final ZonesBoard2Entity.BoardImage image;
        private final Identifier texture;
        private final String translationKey;

        public ImageOption(ZonesBoard2Entity.BoardImage image, Identifier texture, String translationKey) {
            this.image = image;
            this.texture = texture;
            this.translationKey = translationKey;
        }

        public ZonesBoard2Entity.BoardImage getImage() {
            return image;
        }
