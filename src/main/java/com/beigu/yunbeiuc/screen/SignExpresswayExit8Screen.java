...
public class SignExpresswayExit8Screen extends Screen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(
                ButtonWidget.builder(Text.translatable("text.yunbeiuc.direction.north"), button -> {
                    direction2 = SignExpresswayExit8Entity.Direction.NORTH;
                }).dimensions(panelX + 10, panelY + 65, 45, 20).build()
        );
        this.addDrawableChild(
                ButtonWidget.builder(Text.translatable("text.yunbeiuc.direction.south"), button -> {
                    direction2 = SignExpresswayExit8Entity.Direction.SOUTH;
                }).dimensions(panelX + 58, panelY + 65, 45, 20).build()
        );
        this.addDrawableChild(
                ButtonWidget.builder(Text.translatable("text.yunbeiuc.direction.west"), button -> {
                    direction2 = SignExpresswayExit8Entity.Direction.WEST;
                }).dimensions(panelX + 106, panelY + 65, 45, 20).build()
        );
        this.addDrawableChild(
                ButtonWidget.builder(Text.translatable("text.yunbeiuc.direction.east"), button -> {
                    direction2 = SignExpresswayExit8Entity.Direction.EAST;
                }).dimensions(panelX + 154, panelY + 65, 45, 20).build()
        );

        // Expressway 2 buttons
        this.addDrawableChild(
                ButtonWidget.builder(Text.translatable("text.yunbeiuc.expressway.national"), button -> {
                    expressway2 = SignExpresswayExit8Entity.Expressway.NATIONAL;
                }).dimensions(panelX + 210, panelY + 65, 80, 20).build()
        );
        this.addDrawableChild(
                ButtonWidget.builder(Text.translatable("text.yunbeiuc.expressway.provincial"), button -> {
                    expressway2 = SignExpresswayExit8Entity.Expressway.PROVINCIAL;
                }).dimensions(panelX + 295, panelY + 65, 80, 20).build()
        );
        ...
        this.expresswayNumber1TextField.setPlaceholder(Text.translatable("text.yunbeiuc.sign_expressway_exit_8.placeholder"));
        ...
        this.expresswayNumber2TextField.setPlaceholder(Text.translatable("text.yunbeiuc.sign_expressway_exit_8.placeholder"));
        ...
        this.text1TextField.setPlaceholder(Text.translatable("text.yunbeiuc.sign_expressway_exit_8.placeholder"));
        ...
        this.text2TextField.setPlaceholder(Text.translatable("text.yunbeiuc.sign_expressway_exit_8.placeholder"));
        ...
        this.exitNumberTextField.setPlaceholder(Text.translatable("text.yunbeiuc.sign_expressway_exit_8.placeholder"));
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTextWithShadow(
                this.textRenderer,
                Text.translatable("text.yunbeiuc.sign_expressway_exit_8.1_name"),
                panelX + 10, panelY + 31,
                0xFFAAAAAA
        );
        ...
        context.drawTextWithShadow(
                this.textRenderer,
                Text.translatable("text.yunbeiuc.sign_expressway_exit_8.2_name"),
                panelX + 10, panelY + 56,
                0xFFAAAAAA
        );
        ...
        context.drawTextWithShadow(
                this.textRenderer,
                Text.translatable("text.yunbeiuc.sign_expressway_exit_8.expressway_number_1_name"),
                panelX + 10, panelY + 96,
                0xFFAAAAAA
        );
        ...
        context.drawTextWithShadow(
                this.textRenderer,
                Text.translatable("text.yunbeiuc.sign_expressway_exit_8.expressway_number_2_name"),
        ...
        context.drawTextWithShadow(
                this.textRenderer,
                Text.translatable("text.yunbeiuc.sign_expressway_exit_8.text_1_name"),
        ...
        context.drawTextWithShadow(
                this.textRenderer,
                Text.translatable("text.yunbeiuc.sign_expressway_exit_8.text_2_name"),
        ...
        context.drawTextWithShadow(
                this.textRenderer,
                Text.translatable("text.yunbeiuc.sign_expressway_exit_8.exit_number_name"),
