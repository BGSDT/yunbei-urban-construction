...
public class RoadPolesTextDisplayBlockEntityRenderer implements BlockEntityRenderer<RoadPolesTextDisplayEntity> {
    private final TextRenderer textRenderer;

    public RoadPolesTextDisplayBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
