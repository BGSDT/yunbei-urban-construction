...
import com.beigu.yunbeiuc.screen.ZonesBoard2Screen;
...
public class ZonesBoard2 extends BlockWithEntity implements BlockEntityProvider {
    ...
    public ZonesBoard2(Settings settings) {
        super(settings);
    ...
    private void openTextDisplayScreen(BlockPos pos) {
        if (MinecraftClient.getInstance().world != null) {
            ...
            if (blockEntity instanceof ZonesBoard2Entity zonesBoardEntity) {
                MinecraftClient.getInstance().setScreen(new ZonesBoard2Screen(pos));
            }
        }
    }
    ...
    private Type determineType(BlockState behindState) {
        // 遍历后面方块的所有属性，查找名为 "type" 的 EnumProperty
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new ZonesBoard2Entity(pos, state);
    }
