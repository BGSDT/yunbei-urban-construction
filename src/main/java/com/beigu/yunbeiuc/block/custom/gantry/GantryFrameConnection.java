...
public class GantryFrameConnection extends Block {
    ...
    private BlockState updateConnectionType(BlockState state, WorldAccess world, BlockPos pos) {
        ...
        boolean hasMainRight = world.getBlockState(pos.offset(right)).isOf(MunicipalBlocks.GANTRY_FRAME_MAIN);
        boolean hasMainLeft = world.getBlockState(pos.offset(left)).isOf(MunicipalBlocks.GANTRY_FRAME_MAIN);
