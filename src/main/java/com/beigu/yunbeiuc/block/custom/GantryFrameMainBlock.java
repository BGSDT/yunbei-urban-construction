...
import com.beigu.yunbeiuc.block.custom.data.GantryFrameMainType;
...
public class GantryFrameMainBlock extends Block {
    ...
    private BlockPos findLeftFrame(WorldAccess world, BlockPos startPos) {
        ...
        while (world.getBlockState(leftPos).getBlock() instanceof GantryFrameMainBlock) {
            currentPos = leftPos;
    ...
    private int getPositionFromLeft(WorldAccess world, BlockPos leftPos, BlockPos targetPos) {
        ...
        while (!currentPos.equals(targetPos)) {
            ...
            if (!(world.getBlockState(currentPos).getBlock() instanceof GantryFrameMainBlock)) {
    ...
    private void updateConnectedFrames(World world, BlockPos pos) {
        ...
        if (currentState.getBlock() instanceof GantryFrameMainBlock) {
        ...
        if (eastState.getBlock() instanceof GantryFrameMainBlock) {
        ...
        if (westState.getBlock() instanceof GantryFrameMainBlock) {
