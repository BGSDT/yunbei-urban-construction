...
public class SignBlue2Block extends Block {
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;
    public static final EnumProperty<Type> TYPE = EnumProperty.of("type", Type.class);

    private static final VoxelShape SHAPE_POLE_L_N = Block.createCuboidShape(-4, 0, 20.1, 20, 16, 21);
    private static final VoxelShape SHAPE_POLE_L_E = Block.createCuboidShape(-5.1, 0, -2, -4, 16, 18);
    private static final VoxelShape SHAPE_POLE_L_S = Block.createCuboidShape(-4, 0, -5.1, 20, 16, -4);
    private static final VoxelShape SHAPE_POLE_L_W = Block.createCuboidShape(21, 0, -2, 22.1, 16, 18);
    private static final VoxelShape SHAPE_POLE_H_N = Block.createCuboidShape(-4, 0, 21.1, 20, 16, 22);
    private static final VoxelShape SHAPE_POLE_H_E = Block.createCuboidShape(-5.1, 0, -2, -4, 16, 18);
    private static final VoxelShape SHAPE_POLE_H_S = Block.createCuboidShape(-4, 0, -5.1, 20, 16, -4);
    private static final VoxelShape SHAPE_POLE_H_W = Block.createCuboidShape(21, 0, -2, 22.1, 16, 18);
    private static final VoxelShape SHAPE_NORMAL_N = Block.createCuboidShape(-4, 0, 15.1, 20, 16, 16);
    ...
    public SignBlue2Block(Settings settings) {
        super(settings);
