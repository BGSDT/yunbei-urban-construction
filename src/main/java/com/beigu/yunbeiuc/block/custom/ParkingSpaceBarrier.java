...
public class ParkingSpaceBarrier extends Block {
    public ParkingSpaceBarrier(Settings settings) {
        super(settings);
    ...
    private static final VoxelShape SHAPE_N = Block.createCuboidShape(0, 0.0068, 6.5, 16, 3.7568, 9.5);
    private static final VoxelShape SHAPE_E = Block.createCuboidShape(6.5, 0.0068, 0, 9.5, 3.7568, 16);
    private static final VoxelShape SHAPE_S = Block.createCuboidShape(0, 0.0068, 6.5, 16, 3.7568, 9.5);
    private static final VoxelShape SHAPE_W = Block.createCuboidShape(6.5, 0.0068, 0, 9.5, 3.7568, 16);
