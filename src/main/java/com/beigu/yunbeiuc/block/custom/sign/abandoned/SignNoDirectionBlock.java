...
public class SignNoDirectionBlock extends Block implements BlockEntityProvider {
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;
    public static final EnumProperty<SignNoDirection> DIRECTION_TYPE = EnumProperty.of("direction_type", SignNoDirection.class);
    ...
    public SignNoDirectionBlock(Settings settings) {
        super(settings);
        this.setDefaultState(this.getStateManager().getDefaultState().with(FACING, Direction.NORTH)
                .with(DIRECTION_TYPE, SignNoDirection.SIGN_NO_LEFT_TURN));
    }
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new SignNoDirectionBlockEntity(pos, state);
    }
        ...
        if (world.isClient) {
            ...
            if (blockEntity instanceof SignNoDirectionBlockEntity directionBlockEntity) {
                ...
                MinecraftClient.getInstance().setScreen(
                        new SignNoDirectionScreen(Text.empty(), pos, directionBlockEntity.getDirectionType())
                );
            }
        }
