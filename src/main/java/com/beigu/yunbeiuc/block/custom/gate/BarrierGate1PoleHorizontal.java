...
public class BarrierGate1PoleHorizontal extends Block {
    ...
    private static final VoxelShape SHAPE_NORMAL_N = Block.createCuboidShape(0.5, 1.75, 12.5, 16.5, 3.25, 14);
    private static final VoxelShape SHAPE_NORMAL_S = Block.createCuboidShape(0.5, 1.75, 14, 16.5, 3.25, 16.5);
    private static final VoxelShape SHAPE_NORMAL_E = Block.createCuboidShape(12.5, 1.75, 0.5, 14, 3.25, 16.5);
    private static final VoxelShape SHAPE_NORMAL_W = Block.createCuboidShape(14, 1.75, 0.5, 16.5, 3.25, 16.5);
    private static final VoxelShape SHAPE_SLAB_N = Block.createCuboidShape(0.5, -5.25, 12.5, 16.5, -3.75, 14);
    private static final VoxelShape SHAPE_SLAB_S = Block.createCuboidShape(0.5, -5.25, 14, 16.5, -3.75, 16.5);
    private static final VoxelShape SHAPE_SLAB_E = Block.createCuboidShape(12.5, -5.25, 0.5, 14, -3.75, 16.5);
    private static final VoxelShape SHAPE_SLAB_W = Block.createCuboidShape(14, -5.25, 0.5, 16.5, -3.75, 16.5);
