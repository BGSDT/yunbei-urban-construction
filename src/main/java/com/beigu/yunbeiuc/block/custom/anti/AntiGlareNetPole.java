...
public class AntiGlareNetPole extends Block {
    ...
    private static final VoxelShape SHAPE_N = Stream.of(
            Block.createCuboidShape(0, 1, 7.75, 6.75, 15, 8.25),
            Block.createCuboidShape(9.25, 1, 7.75, 16, 15, 8.25),
            Block.createCuboidShape(6.75, 0, 6.75, 9.25, 16, 9.25)
    ...
    private static final VoxelShape SHAPE_E = Stream.of(
            Block.createCuboidShape(7.75, 1, 0, 8.25, 15, 6.75),
            Block.createCuboidShape(7.75, 1, 9.25, 8.25, 15, 16),
            Block.createCuboidShape(6.75, 0, 6.75, 9.25, 16, 9.25)
    ).reduce((v1, v2) -> VoxelShapes.combineAndSimplify(v1, v2, BooleanBiFunction.OR)).get();
    ...
    public AntiGlareNetPole(Settings settings) {
        super(settings);
