...
public class SignBlocks {
    ...
    public static final Block SIGN_YIELD = register("sign_yield", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    ...
    public static final Block SIGN_INDICATION_LANE_DIRECTION_RIGHT_TURN = register("sign_indication_lane_direction_right_turn", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_LEFT_TURN = register("sign_indication_lane_direction_left_turn", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_STRAIGHT = register("sign_indication_lane_direction_straight", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_STRAIGHT_RIGHT_TURN = register("sign_indication_lane_direction_straight_right_turn", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_STRAIGHT_LEFT_TURN = register("sign_indication_lane_direction_straight_left_turn", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_SINGLE_LEFT_TURN_AROUND = register("sign_indication_lane_direction_single_left_turn_around", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_LEFT_TURN_AROUND = register("sign_indication_lane_direction_left_turn_around", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    ...
    public static final Block SIGN_INDICATION_LANE_DIRECTION_MOTOR_VEHICLES = register("sign_indication_lane_direction_motor_vehicles", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_MOTOR_VEHICLES_STRAIGHT = register("sign_indication_lane_direction_motor_vehicles_straight", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_MOTOR_VEHICLES_LEFT_SIDE_MEDIAN_STRIP = register("sign_indication_lane_direction_motor_vehicles_left_side_median_strip", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_MOTOR_VEHICLES_RIGHT_SIDE_MEDIAN_STRIP = register("sign_indication_lane_direction_motor_vehicles_right_side_median_strip", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));

    public static final Block SIGN_INDICATION_LANE_DIRECTION_SMALL_PASSENGER_CAR = register("sign_indication_lane_direction_small_passenger_car", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_SMALL_PASSENGER_CAR_STRAIGHT = register("sign_indication_lane_direction_small_passenger_car_straight", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_SMALL_PASSENGER_CAR_LEFT_SIDE_MEDIAN_STRIP = register("sign_indication_lane_direction_small_passenger_car_left_side_median_strip", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_SMALL_PASSENGER_CAR_RIGHT_SIDE_MEDIAN_STRIP = register("sign_indication_lane_direction_small_passenger_car_right_side_median_strip", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));

    public static final Block SIGN_INDICATION_LANE_DIRECTION_LARGE_BUS = register("sign_indication_lane_direction_large_bus", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_LARGE_BUS_STRAIGHT = register("sign_indication_lane_direction_large_bus_straight", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_LARGE_BUS_LEFT_SIDE_MEDIAN_STRIP = register("sign_indication_lane_direction_large_bus_left_side_median_strip", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_LARGE_BUS_RIGHT_SIDE_MEDIAN_STRIP = register("sign_indication_lane_direction_large_bus_right_side_median_strip", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_LARGE_BUS_TEXT = register("sign_indication_lane_direction_large_bus_text", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_LARGE_BUS_TEXT_STRAIGHT = register("sign_indication_lane_direction_large_bus_text_straight", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_LARGE_BUS_TEXT_LEFT_SIDE_MEDIAN_STRIP = register("sign_indication_lane_direction_large_bus_text_left_side_median_strip", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_LARGE_BUS_TEXT_RIGHT_SIDE_MEDIAN_STRIP = register("sign_indication_lane_direction_large_bus_text_right_side_median_strip", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));

    public static final Block SIGN_INDICATION_LANE_DIRECTION_LARGE_BUS_BRT = register("sign_indication_lane_direction_large_bus_brt", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_LARGE_BUS_BRT_STRAIGHT = register("sign_indication_lane_direction_large_bus_brt_straight", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_LARGE_BUS_BRT_LEFT_SIDE_MEDIAN_STRIP = register("sign_indication_lane_direction_large_bus_brt_left_side_median_strip", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_LARGE_BUS_BRT_RIGHT_SIDE_MEDIAN_STRIP = register("sign_indication_lane_direction_large_bus_brt_right_side_median_strip", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));

    public static final Block SIGN_INDICATION_LANE_DIRECTION_TRAM_STRAIGHT = register("sign_indication_lane_direction_tram_straight", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));

    public static final Block SIGN_INDICATION_LANE_DIRECTION_HOV = register("sign_indication_lane_direction_hov", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    ...
    public static final Block SIGN_INDICATION_LANE_DIRECTION_NON_MOTOR_VEHICLES = register("sign_indication_lane_direction_non_motor_vehicles", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_NON_MOTOR_VEHICLES_STRAIGHT = register("sign_indication_lane_direction_non_motor_vehicles_straight", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_NON_MOTOR_VEHICLES_LEFT_SIDE_MEDIAN_STRIP = register("sign_indication_lane_direction_non_motor_vehicles_left_side_median_strip", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_NON_MOTOR_VEHICLES_RIGHT_SIDE_MEDIAN_STRIP = register("sign_indication_lane_direction_non_motor_vehicles_right_side_median_strip", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    ...
    public static final Block SIGN_INDICATION_LANE_DIRECTION_ELECTRIC_VEHICLE = register("sign_indication_lane_direction_electric_vehicle", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_ELECTRIC_VEHICLE_STRAIGHT = register("sign_indication_lane_direction_electric_vehicle_straight", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_ELECTRIC_VEHICLE_LEFT_SIDE_MEDIAN_STRIP = register("sign_indication_lane_direction_electric_vehicle_left_side_median_strip", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_INDICATION_LANE_DIRECTION_ELECTRIC_VEHICLE_RIGHT_SIDE_MEDIAN_STRIP = register("sign_indication_lane_direction_electric_vehicle_right_side_median_strip", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    ...
    public static final Block ZONES_BOARD_ARROW_LEFT = register("zones_board_arrow_left", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block ZONES_BOARD_ARROW_RIGHT = register("zones_board_arrow_right", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block ZONES_BOARD_TWO_WAY = register("zones_board_two_way", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block ZONES_BOARD_RED = register("zones_board_red", new ZonesBoard1(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block ZONES_BOARD_YELLOW = register("zones_board_yellow", new ZonesBoard1(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block ZONES_BOARD_WHITE = register("zones_board_white", new ZonesBoard1(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block ZONES_BOARD_IMAGE = register("zones_board_image", new ZonesBoard2(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
...
//    public static final Block SIGN_GUIDE_INTERSECTION_ADVANCE_WARNING_8 = register("sign_guide_intersection_advance_warning_8", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    ...
    public static final Block SIGN_GUIDE_INTERSECTION_ADVANCE_WARNING_6 = register("sign_guide_intersection_advance_warning_6", new SignGuideIntersectionAdvanceWarning6(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_GUIDE_INTERSECTION_ADVANCE_WARNING_7 = register("sign_guide_intersection_advance_warning_7", new SignGuideIntersectionAdvanceWarning7(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_GUIDE_INTERSECTION_ADVANCE_WARNING_8 = register("sign_guide_intersection_advance_warning_8", new SignGuideIntersectionAdvanceWarning6(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));

    public static final Block SIGN_GUIDE_INTERSECTION_WARNING_1 = register("sign_guide_intersection_warning_1", new SignGuideIntersectionWarning1(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_GUIDE_INTERSECTION_WARNING_2 = register("sign_guide_intersection_warning_2", new SignGuideIntersectionWarning1(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_GUIDE_INTERSECTION_WARNING_3 = register("sign_guide_intersection_warning_3", new SignGuideIntersectionWarning1(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_GUIDE_INTERSECTION_WARNING_4 = register("sign_guide_intersection_warning_4", new SignGuideIntersectionWarning4(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_GUIDE_INTERSECTION_WARNING_5 = register("sign_guide_intersection_warning_5", new SignGuideIntersectionWarning4(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_GUIDE_INTERSECTION_WARNING_6 = register("sign_guide_intersection_warning_6", new SignGuideIntersectionWarning1(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));

    public static final Block SIGN_GUIDE_CONFIRMATION_1 = register("sign_guide_confirmation_1", new SignGuideConfirmation1(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    public static final Block SIGN_GUIDE_CONFIRMATION_2 = register("sign_guide_confirmation_2", new SignGuideConfirmation1(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    ...
    public static final Block SIGN_EXPRESSWAY_EXIT_8 = register("sign_expressway_exit_8", new SignExpresswayExit8(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
