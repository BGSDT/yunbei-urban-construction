...
public class SignBlocks {
    ...
    public static final Block SIGN_SLOW = register("sign_slow", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
    ...
    public static final Block SIGN_WRONG_WAY = register("sign_wrong_way", new SignSimpleBlock(AbstractBlock.Settings.copy(Blocks.CYAN_TERRACOTTA).nonOpaque().requiresTool()));
